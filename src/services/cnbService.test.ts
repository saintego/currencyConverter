...
describe('convertCurrency', () => {
  const usd: ExchangeRate = { country: 'USA', currency: 'dollar', amount: 1, code: 'USD', rate: 22.5 };
  const jpy: ExchangeRate = { country: 'Japan', currency: 'yen', amount: 100, code: 'JPY', rate: 15.0 };
